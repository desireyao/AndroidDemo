package com.yaoh.AndroidDemo.zip;
...
public final class ZipUtils {
    ...
    public static final String RES_FILE_PATH
            = Environment.getExternalStoragePublicDirectory("Beacool").getAbsolutePath() + "/MoreThan/Log";

    public static final String ZIP_FILE_PATH
            = Environment.getExternalStoragePublicDirectory("Beacool").getAbsolutePath() + "/MoreThan/log.zip";
