package com.yaoh.AndroidDemo.view.scrlloview;

/**
 * Package com.yaoh.demo.view.scrlloview.
 * Created by yaoh on 2017/11/02.
...
//        lp.width = (int) (dropZoomViewWidth * ((dropZoomViewWidth + s) / dropZoomViewWidth));
    ...
    public boolean isNeedMove() {
        ...
        Log.e(TAG,"offset = " + offset + " scrollY = " + scrollY);
